...
export default function ScriptExample() {
  ...
  return (
    <>
      ...
      <span className="text-gray-400">This script takes a number and simply echoes it back.</span>

      <Link href="https://docs.fuel.network/docs/intro/glossary/#script" className="mt-4">
